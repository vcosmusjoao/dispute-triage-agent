      ...
      <div className="flex flex-col gap-10">
        <section>
          ...
          <p className="mt-2 text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
            A cardholder disputes a charge with their bank (the <em>issuer</em>), and the issuer
            reverses the money from the merchant immediately — a provisional credit to the
            cardholder, taken as fact until proven otherwise. Only after that reversal does the
            merchant get a chance to argue back. It&apos;s guilty-until-proven-innocent from the
            merchant&apos;s side, which is the entire reason the rest of this process exists.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2 text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
            ...
            claim, where AVS/CVV/3DS authentication signals matter instead. That&apos;s why{" "}
            <code>classify</code> — interpreting the code before any judgment happens — is the
            agent&apos;s first step, not an afterthought.
          </p>
        </section>

        <section>
          <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">
            Fight or accept: representment
          </h2>
          <p className="mt-2 text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
            To fight a chargeback, the merchant submits a formal written rebuttal — a{" "}
            <em>representment</em> letter — with documented evidence that the charge was
            legitimate. That takes real effort, and fighting isn&apos;t free even when you have a
            case: card networks track how often merchants dispute and lose, and fighting too
            often on weak evidence has its own cost. So the actual decision is a judgment call,
            weighing the odds of winning against the cost of trying — not just &quot;do we have
        ...
        <section>
          ...
          <p className="mt-2 text-sm leading-relaxed text-neutral-700 dark:text-neutral-300">
            ...
            would. That reasoning step — not the drafting — is where this agent earns its keep
            over a spreadsheet of if/else rules.
          </p>
        </section>

        <Link
          href="/"
          className="self-start rounded-lg bg-neutral-900 px-5 py-2.5 font-medium text-white transition hover:bg-neutral-700 dark:bg-white dark:text-neutral-900 dark:hover:bg-neutral-200"
        >
          Try the demo →
        </Link>
      </div>
